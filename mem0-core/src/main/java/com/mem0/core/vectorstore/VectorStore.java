 ...
 * Provides abstraction over different vector store implementations.
 *
 * @author MoBai
...
public interface VectorStore {
     ...
     */
    List<VectorEntry> list(Map<String, Object> filters, Integer limit);
     ...
     */
    default List<SearchResult> keywordSearch(String query, Integer topK, Map<String, Object> filters) {
        throw new UnsupportedOperationException("Keyword search not supported by this vector store");
    }
    ...
    default List<String> listCollections() {
        throw new UnsupportedOperationException("List collections not supported by this vector store");
    }
    ...
    default Map<String, Object> collectionInfo(String name) {
        throw new UnsupportedOperationException("Collection info not supported by this vector store");
    }
     ...
     * Lists vectors with optional filters.
     * <p>
     * Note: The result does not contain vectors.
     *
     * @param filters the metadata filters
     * @param limit   the maximum number of results
     * @return the vector entries
     */
    default List<MemoryVectorEntry> listWithoutVector(Map<String, Object> filters, int limit) {
        return null;
    }
     ...
     * @return the vector entry
     */
    default Optional<MemoryVectorEntry> getByIdWithoutVector(String id) {
        return null;
    }
}
